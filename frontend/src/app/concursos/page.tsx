...
import { fmtFecha, type Concurso } from "@/lib/pivote/types";
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead className="bg-surface-container-high">
                <tr>
                  {["Concurso", "Entidad", "Presentación", "Postores", "A revisión", ""].map((h, i) => (
              ...
              <tbody className="divide-y divide-outline-variant/10">
                {visibles.map((c) => (
                  <tr key={c.concurso_id} className="hover:bg-surface-container-high/40 transition-colors">
                    ...
                    <td className="px-5 py-3.5 text-xs text-outline whitespace-nowrap">{fmtFecha(c.fecha_presentacion)}</td>
                    <td className="px-5 py-3.5">
